...
/**
 * Интерфейс, определяющий методы для чтения и записи StorageState в любом внешнем хранилище данных
 * (базе данных, файле, сокете и т.д.).
 */
public interface StorageService {
  /**
   * Метод собирает состояние всех репозиториев и сохраняет во внешнее постоянное хранилище согласно
   * структуре объекта StorageState при выключении сервиса.
   */
   ...
   * и возвращает объект, из которого репозитории потом могут загрузить нужные им данные при
   * включении сервиса.
   */
